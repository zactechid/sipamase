                    ...
                    <div class="card-header">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="d-flex flex-wrap mt-3">
                                ...
                                <a href="/penyampaian" class="btn btn-danger ml-2"><i class="fas fa-filter"></i> Reset</a>
                            </form>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($harmonisasi as $item)
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td>
                                                @if ($item->doc_administrasi->docx1 !== null)
                                                    <a class="badge badge-info mr-2 mt-1 p-1" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx1 }}" target="_blank">Dokumen Surat Selesai. <i class="fas fa-download"></i></a>
                                                @else
                                                ...
                                                @elseif($item->doc_rapat->docx1 !== null)
                                                    <a class="badge badge-info mr-2 mt-1 p-1" href="{{ secure_url('storage') }}/{{ $item->doc_rapat->docx1 }}" target="_blank">Dokumen Draft Bersih. <i class="fas fa-download"></i></a>
                                                @else
                                                    <a class="badge badge-danger mr-2 mt-1 p-1" target="_blank"> Belum ada dokumen</a>
                                                @endif
                                                ...
                                                @elseif($item->doc_penyampaian->docx1 !== null)
                                                    <a class="badge badge-info mr-2 mt-1 p-1" href="{{ secure_url('storage') }}/{{ $item->doc_penyampaian->docx1 }}" target="_blank">Dokumen BAP. <i class="fas fa-download"></i></a>
                                                @else
                                                    <a class="badge badge-danger mr-2 mt-1 p-1" target="_blank"> Belum ada dokumen</a>
                                                @endif
                                            </td>
                                        ...
                                        <td>{{ isset($item->doc_penyampaian->keterangan) ? $item->doc_penyampaian->keterangan  : '' }}</td>
                                        <td class="text-center">
