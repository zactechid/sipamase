                                ...
                                @foreach ($harmonisasi as $item)
                                 <?php
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td>
                                                <a class="badge badge-info mr-2 mt-1 p-1 {{ ($item->doc_administrasi->docx1) ? '' : 'd-none' }}" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx1 }}" target="_blank">Dokumen LPA/AK. <i class="fas fa-download"></i></a>
                                                {{-- <a class="badge badge-info mr-2 mt-1 p-1 {{ ($item->doc_administrasi->docx2) ? '' : 'd-none' }}" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx2 }}" target="_blank">2. <i class="fas fa-download"></i></a>
                                                <a class="badge badge-info mr-2 mt-1 p-1 {{ ($item->doc_administrasi->docx3) ? '' : 'd-none' }}" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx3 }}" target="_blank">3. <i class="fas fa-download"></i></a>
                                                <a class="badge badge-info mr-2 mt-1 p-1 {{ ($item->doc_administrasi->docx4) ? '' : 'd-none' }}" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx4 }}" target="_blank">4. <i class="fas fa-download"></i></a>
                                                <a class="badge badge-info mr-2 mt-1 p-1 {{ ($item->doc_administrasi->docx5) ? '' : 'd-none' }}" href="{{ secure_url('storage') }}/{{ $item->doc_administrasi->docx5 }}" target="_blank">5. <i class="fas fa-download"></i></a> --}}
                                            </td>
                                        @endif
